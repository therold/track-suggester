...
$(document).ready(function() {
  $("form#user-input").submit(function(event){
    ...
    var firstAnswer = $("input:radio[name=question1]:checked").val();
    var secondAnswer = $("input:radio[name=question2]:checked").val();
    var thirdAnswer = $("input:radio[name=question3]:checked").val();
    var fourthAnswer = $("input:radio[name=question4]:checked").val();
    var fifthAnswer = $("input:radio[name=question5]:checked").val();
